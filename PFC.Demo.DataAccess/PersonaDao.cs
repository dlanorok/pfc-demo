...
namespace PFC.Demo.DataAccess
{
    public static class PersonaDao
    {
        ...
        /// <returns></returns>
        public static PersonaViewModel GetById(int id, SqlConnection connection, SqlTransaction transaction = null)
        {
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        public static List<PersonaEntity> GetAll(SqlConnection connection, SqlTransaction transaction = default)
        {
        ...
        /// <param name="connection"></param>
        /// <param name="transaction"></param>
        public static void Create(PersonaUpdateModel persona, SqlConnection connection, SqlTransaction transaction)
        {
            SqlCommand mCommand = new SqlCommand();
            try
            {
        ...
        /// <param name="connection"></param>
        /// <param name="transaction"></param>
        public static void Update(int id, PersonaUpdateModel persona, SqlConnection connection, SqlTransaction transaction)
        {
            SqlCommand mCommand = new SqlCommand();
            try
            {
