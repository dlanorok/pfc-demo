...
namespace PFC.Demo.DataAccess
{
    public static class CuentaBancariaDao
    {
        ...
        /// <returns></returns>
        public static CuentaBancariaEntity GetById(
            int id,
        ...
        )
        {
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    ...
                    CuentaBancaria.Tipo         = reader.GetShortValue("Tipo");
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        public static List<CuentaBancariaEntity> GetAllByPersonaId(
            int personaId,
            SqlConnection connection,
            SqlTransaction transaction = default)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    var CuentaBancaria = new CuentaBancariaEntity
                    {
                        ...
                        Tipo         = reader.GetShortValue("Tipo"),
        ...
        public static void Create(
            CuentaBancariaUpdateEntity CuentaBancaria,
            SqlConnection connection,
            SqlTransaction transaction)
        {
            ...
            try
            {
                ...
                mCommand.Parameters.AddWithValue("@Tipo", CuentaBancaria.Tipo);
        ...
        /// <param name="connection"></param>
        /// <param name="transaction"></param>
        public static void Update(int id, CuentaBancariaUpdateEntity CuentaBancaria, SqlConnection connection,
            SqlTransaction transaction)
        {
            SqlCommand mCommand = new SqlCommand();
            try
